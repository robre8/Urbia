      ...
      <SheetContent className="overflow-y-auto px-4 flex flex-col gap-2">
        <form onSubmit={handleSubmit}>
          <SheetHeader className="space-y-2">
            ...
            <SheetDescription>
              Por favor, completa los siguientes campos para reportar un incidente.
            </SheetDescription>
          </SheetHeader>
          ...
          <div className="grid gap-8 py-4">
            ...
            <div className="grid gap-3">
              ...
              <Select 
                ...
                onValueChange={(value) => handleInputChange('reportTypeId', value)}
              ...
              {errors.reportTypeId && <span className="text-red-500 text-sm">Este campo es requerido</span>}
            </div>
            ...
            <div className="grid gap-3">
              ...
              <div className="flex justify-between">
                {errors.title && <span className="text-red-500 text-sm">Máximo 50 caracteres</span>}
                <span className={`text-sm ml-auto ${charCount.title > 50 ? 'text-red-500' : 'text-gray-500'}`}>
                  {charCount.title}/50
                </span>
              </div>
            </div>
            ...
            <div className="grid gap-3">
              ...
              <div className="relative">
                <Textarea
                  ...
                  className={`resize-none h-64 pb-10 ${errors.description ? 'border-red-500' : ''}`}
                  placeholder="Descripción del reporte"
                />
                <div className="flex justify-between mt-2">
                  {errors.description && <span className="text-red-500 text-sm">Máximo 100 caracteres</span>}
                  <span className={`text-sm ml-auto ${charCount.description > 200 ? 'text-red-500' : 'text-gray-500'}`}>
          ...
          <div className="flex flex-col justify-center gap-2 ">
            <Button type="submit"  className="bg-gray-300 text-gray-800 hover:bg-gray-400 w-full rounded-[10px]">Reportar</Button>
            <Button  type="button" className="hover:bg-gray-500 w-full rounded-[10px]" onClick={handleCancel}>Cancelar</Button>
          </div>
        </form>
      </SheetContent>
    </Sheet>

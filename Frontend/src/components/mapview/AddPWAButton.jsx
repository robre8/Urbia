    ...
    <TooltipProvider>
      <div className="relative flex items-center gap-2 z-[9999]">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <motion.button
              className=" hidden lg:flex items-center justify-center w-12 h-12 rounded-full border border-gray-300 shadow-md bg-white hover:bg-gray-100 text-gray-800 transition z-[9999]"
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
